...
abstract final class AppColors {
  ...
  static const Color textMuted = Color(0xFF69706E);
  static const Color border = Color(0xFFE2E8DD);
  static const Color checkboxBorder = Color(0xFFC7CCC7);
  static const Color dividerText = Color(0xFF9AA89C);
  static const Color iconBackground = Color(0xFFDCE7D4);
  static const Color error = Color(0xFFC0392B);
  static const Color errorBackground = Color(0xFFF7E3E0);
  static const Color successBackground = Color(0xFFD9EFE0);
