    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            VapeOrderFlowStrings.payWithinTitle,
          ...
          SizedBox(height: 6.h),
          Text(
            VapeOrderFlowStrings.payWithinSubtitle,
            textAlign: TextAlign.center,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2.h),
                    Text(
                      VapeOrderFlowStrings.tapPayToComplete,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  VapeOrderFlowStrings.warrantyNote,
                  style: AppTextStyles.caption(color: const Color(0xFF6B756E)).copyWith(
                    fontWeight: FontWeight.w400,
                    fontSize: 12.sp,
                    height: 1.25,
