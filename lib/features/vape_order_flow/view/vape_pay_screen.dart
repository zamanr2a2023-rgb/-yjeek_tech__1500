...
class VapePayScreen extends ConsumerStatefulWidget {
  const VapePayScreen({super.key, this.orderIds = const []});

  final List<String> orderIds;

  @override
  ConsumerState<VapePayScreen> createState() => _VapePayScreenState();
}

class _VapePayScreenState extends ConsumerState<VapePayScreen> {
  ...
  String _method = VapeOrderFlowStrings.applePay;
  String _subtotal = '—';
  String _delivery = '—';
  ...
  Future<void> _hydrate() async {
    ...
    if (allPaid) {
      ...
      context.pushReplacement(
        VapeOrderFlowRoutes.confirmedFor(widget.orderIds),
      );
    }
  }
