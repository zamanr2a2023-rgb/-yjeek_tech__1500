...
class VapeReceiptScreen extends ConsumerStatefulWidget {
  const VapeReceiptScreen({super.key, this.orderIds = const []});

  final List<String> orderIds;

  @override
  ConsumerState<VapeReceiptScreen> createState() => _VapeReceiptScreenState();
}

class _VapeReceiptScreenState extends ConsumerState<VapeReceiptScreen> {
                    ...
                    VapeReceiptPaper(
                      ...
                      items: [
                        for (final i in items)
                          VapeReceiptLine(name: i.name, price: i.price),
                      ],
                      billLines: billLines,
